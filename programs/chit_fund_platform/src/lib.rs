...
declare_id!("CrAEEmFufm1sTY3KHAmnKkj1yq2JPZux5PhrxquDc4cZ");
...
pub mod chit_fund_platform {
    ...
    pub fn join_chit_fund(ctx: Context<JoinChitFund>) -> Result<()> {
        ...
        require!(chit_fund.is_active, ChitFundError::ChitFundInactive);
        ...
        //     SplTokenAccount::unpack(&ctx.accounts.user_token_account.try_borrow_data()?)?;
        // require!(
    ...
    pub fn disburse_funds(ctx: Context<DisburseFunds>) -> Result<()> {
        ...
        require!(!borrower.has_borrowed, ChitFundError::AlreadyBorrowed);

        let disbursement_amount = chit_fund
    ...
    pub fn emergency_request(ctx: Context<EmergencyRequest>) -> Result<()> {
        ...
        require!(!participant.has_borrowed, ChitFundError::AlreadyBorrowed);
    ...
    pub fn withdraw_collateral(ctx: Context<WithdrawCollateral>) -> Result<()> {
        ...
        require!(!chit_fund.is_active, ChitFundError::ChitFundActive);
